        ...
        < section >
            {
                isTrue
                    ...
                    <div className="big--wrapper">
                        <div className="title">Orbit Protocol is a new generation on-chain lending protocol that enables future income streams as collateral. We expect the number of on-chain businesses that generate significant revenue to drastically increase and drive demand for an alternative source of capital. Liquidation-free loans and improved capital efficiency for on-chain entities.</div>
